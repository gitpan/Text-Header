...
# $Id: Header.pm,v 1.2 2000/09/28 01:21:51 nwiger Exp $
####################################################################
#
...
$VERSION = do { my @r=(q$Revision: 1.2 $=~/\d+/g); 
                sprintf "%d."."%02d"x$#r,@r };
...
Text::Header - provide RFC 822 C<header> and C<unheader> functions
...
C<header> to be more general pupose, so it can provide SMTP and other
headers as well.

The C<unheader> function works in exactly the opposite direction from
C<header>, pulling apart headers and returning a list. So, assuming
the C<@HEADERS> array shown up top:
